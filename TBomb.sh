...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mProHackersArmy \e[0m"
    else
    ...
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UC19ByFIEDZZZbJ5nhJxFi8g \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By ProHackersArmy > .update
